...
export default function CreateVoteClient() {
    ...
    try {
      const res = await fetch("/api/votes", {
        ...
        body: JSON.stringify({
          ...
          endDate,
          candidates,
          publisher: session.data?.user?.email,
        }),
      });

      if (res.ok) {
        toast.success("Vote berhasil dibuat!", {
          position: "top-center",
          autoClose: 1500,
        });
      ...
      toast.error("Gagal membuat vote. Silakan coba lagi.", {
        position: "top-center",
        autoClose: 3000,
      });
    } finally {
        ...
        <form onSubmit={createVote}>
          <section className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p>
                Silahkan masukkan data yang dibutuhkan sebelum membuat vote
                online
              </p>
            </div>
            <div className="space-y-4">
              ...
              <Form
                value={title}
                title="Judul"
                placeholder="Contoh: Calon Gubernur"
                className="w-96"
